...
######SQL ECHO############
	...
	elseif($postu===$secretname && $postp===$secretpass){
		header( "refresh:0; url=secret.html");
...
<body>
<embed src="mario.mp3" loop="true" autostart="true" width="2" height="0">
<script>
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    document.getElementById("demo").innerHTML = "A játékos idő véget ér";
	 ...
	 <script>
		alert("Figyelem: A CSS része háromfajta felbontásra van optimalizálva. 1366x768, 1920x1080 illetve 2560x1440 . Ha változik a méret, akkor a CSS része nem esik majd egybe a specifikus háttérrel."); 
	</script>
    <main>
	<div id="felsor">
	<table >
	...
	<div id="projekt">
        ...
        <form id="form" name="#" action="#" method="post">
            <div id="div1">
                ...
                <input id="uname" type="text" name="uname" required="required" placeholder="Mario" />
            </div>
		...
		<form action="https://media4.giphy.com/media/lgcUUCXgC8mEo/giphy.gif?cid=ecf05e47c5tfh5a60528gad0c8jq641k8xoslm26esc91n9w&rid=giphy.gif&ct=g">
			<input id="but2" type="submit" value="OK" style="background:transparent; border:none; color:transparent;">
		</form>
		<form action="https://translate.google.com/?sl=hu&tl=en&text=majom&op=translate">
			<input id="but3" type="submit" value="OK" style="background:transparent; border:none; color:transparent;">
		</form>
    </main>
</body>
</html>	
